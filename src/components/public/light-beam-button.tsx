...
function ButtonInner({
  ...
  return (
    <>
      ...
      />
      <span aria-hidden="true" className="absolute inset-[1.5px] -z-10 rounded-full bg-[#050505]" />
      <span
        aria-hidden="true"
